...
INSERT INTO medications (id, workspace_id, name, active_ingredient, concentration_value, concentration_unit, form, sale_price, sale_enabled) VALUES
  ...
  ('med-ws-padilla-14', 'ws-padilla',    'Heparina',     'Heparina',   5000,'unidad','Inyectable', 4200, true),
  ('med-ws-padilla-15', 'ws-padilla',    'Solución NaCl','Cloruro de Sodio',   9,   'mg',  'Solución',  400, true),
  -- Niñez
  ...
  ('med-ws-ninez-14', 'ws-ninez',      'Heparina',     'Heparina',   5000,'unidad',  'Inyectable', 4200, true),
  ('med-ws-ninez-15', 'ws-ninez',      'Solución NaCl','Cloruro de Sodio', 9,'mg','Solución',  400, true),
  -- Mujer
  ...
  ('med-ws-mujer-14', 'ws-mujer',      'Heparina',     'Heparina',   5000,'unidad',  'Inyectable', 4200, true),
  ('med-ws-mujer-15', 'ws-mujer',      'Solución NaCl','Cloruro de Sodio', 9,'mg','Solución',  400, true),
  -- Eva Perón
  ...
  ('med-ws-evaperon-14', 'ws-evaperon', 'Heparina',     'Heparina',   5000,'unidad',  'Inyectable', 4200, true),
  ('med-ws-evaperon-15', 'ws-evaperon', 'Solución NaCl','Cloruro de Sodio', 9,'mg','Solución',  400, true),
  -- Concepción
  ...
  ('med-ws-concepcion-14', 'ws-concepcion', 'Heparina',     'Heparina',   5000,'unidad',  'Inyectable', 4200, true),
  ('med-ws-concepcion-15', 'ws-concepcion', 'Solución NaCl','Cloruro de Sodio', 9,'mg','Solución',  400, true),
  -- Este
  ...
  ('med-ws-este-14', 'ws-este',       'Heparina',     'Heparina',   5000,'unidad',  'Inyectable', 4200, true),
  ('med-ws-este-15', 'ws-este',       'Solución NaCl','Cloruro de Sodio', 9,'mg','Solución',  400, true)
